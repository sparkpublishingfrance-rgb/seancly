...
import { formatScore, initialsOf } from "../utils/format";
    ...
    <section className="shell" aria-label="Notes">
      <div className="social">
        <p className="social__score">
          <IconStar size={17} />
          <span className="social__score-value">{formatScore(average)}</span>
            ...
            <ul className="social__friend-list">
              {friends.map((friend) => (
                <li className="friend" key={friend.handle}>
                  ...
                  <span className="friend__rating">{formatScore(friend.rating)}</span>
                  <span className="sr-only">
                    {friend.handle} a mis {formatScore(friend.rating)} sur 10
                  </span>
                </li>
              ))}
            </ul>
